      ...
      <div className="p-4 md:p-10 lg:p-20">
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-100">
                  ...
                  <TableHead className="text-center font-bold">Remove</TableHead>
                </TableRow>
              </TableHeader>
                ...
                {cart?.cartItems?.length ? (
                  cart.cartItems.map((item) => (
                    <TableRow key={item.id}>
                      ...
                      <TableCell className="text-center">₹{item.menuItem.price}</TableCell>
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 mt-6">
          ...
          <div className="flex gap-2 w-full md:w-1/3 justify-end">
            ...
            <Button className="bg-gray-800">Continue Shopping</Button>
          </div>
        </div>
        ...
        <div className="flex justify-end mt-10">
          <div className="w-full md:w-1/2 lg:w-1/3 border p-6 shadow-md rounded-lg">
            <h1 className="text-gray-600 text-2xl mb-4">Cart Totals</h1>
